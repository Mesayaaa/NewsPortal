          ...
          <div class="panel-body">
            <form method="post" id="edit_form" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <!-- Hidden textarea to store the content with existing article data -->
                <textarea name="article_desc" id="article_desc" style="display: none;"
                  required><?php echo htmlspecialchars($article_desc); ?></textarea>
              </div>
              <div class="form-group">
