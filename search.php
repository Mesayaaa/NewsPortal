          ...
          <form method="GET" class="search-form">
            ...
            <div class="search-input-group mb-4">
              <div class="input-group input-group-lg">
                ...
                <input class="form-control search-main-input" type="text" name="name" id="name"
                  placeholder="Search articles, news, topics..." autocomplete="off"
            ...
            <div class="advanced-filters">
              <div class="row g-3">
                ...
                <div class="col-md-6 col-lg-3">
                  ...
                  <input type="date" name="to_date" id="to_date" class="form-control" max="<?php echo date("Y-m-d") ?>"
                ...
                <div class="col-md-6 col-lg-3">
                  ...
                  <div class="trending-check" id="trending-toggle">
                    <input type="hidden" name="trending" id="trending"
                      value="<?php echo (isset($_GET['trending']) && $_GET['trending'] == '1') ? '1' : '0'; ?>" />
                    <div class="trending-label">
                      <i class="fas fa-chart-line me-2"></i>Trending Only
                    </div>
                  </div>
                </div>
              </div>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    trendingToggle.addEventListener('click', function () {
      if (trendingInput.value === '1') {
        trendingInput.value = '0';
        trendingToggle.classList.remove('active');
      } else {
        trendingInput.value = '1';
        trendingToggle.classList.add('active');
      }
    });
